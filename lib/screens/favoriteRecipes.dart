          ...
          Container(
            ...
            child: GridView(
                ...
                children: List.generate(
                    FavoriteRecipeView.favoriteRecipes.length, (index) {
                  return GridTile(
                    child: Stack(
                      children: [
                        RecipieTile(FavoriteRecipeView.favoriteRecipes[index]),
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: CircleAvatar(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  FavoriteRecipeView.removeFromFavoriteRecipes(
                                      FavoriteRecipeView
                                          .favoriteRecipes[index]);
                                  setState(() {});
                                },
