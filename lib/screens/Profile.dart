            ...
            child: Column(
              ...
              children: [
                ...
                image != null ? ImageWidget(
                     image,
                     (source) => pickImage(ImageSource.gallery)
                ) : GestureDetector(child:ClipOval(
                  child:  Material(  color: Colors.transparent,child: Image.asset('images/noprofilepic.jpg' ,height: 160, width: 160 , fit: BoxFit.fill,)),
                ...
                BuildButton( 'pick from gallery', Icons.photo, ()=> pickImage(ImageSource.gallery)),
                SizedBox(height: 20.0,),
                BuildButton('pick from camera',  Icons.camera_alt_outlined,  ()=> pickImage(ImageSource.camera)),
                SizedBox(height: 20.0,),
